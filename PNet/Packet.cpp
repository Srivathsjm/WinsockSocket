...
namespace PNet
{
	...
	Packet& Packet::operator>>(uint32_t& data)
	{
		...
		{
			throw PacketException("[Packet::operatorc>>(uint32_t &)] - Extraction offset exceeded buffer size.");
		}
	...
	Packet& Packet::operator>>(std::string & data)
	{
		...
		*this >> stringSize;
		...
		{
			throw PacketException("[Packet::operatorc>>(std::string &)] - Extraction offset exceeded buffer size.");
		}
